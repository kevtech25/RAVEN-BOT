...
const appname = process.env.APP_NAME || 'KevoBot';
const herokuapi = process.env.HEROKU_API;
const gptdm = process.env.GPT_INBOX || 'FALSE';
const mode = process.env.MODE || 'PRIVATE';
const anticall = process.env.AUTOREJECT_CALL || 'FALSE';
const botname = process.env.BOTNAME || 'KEVO-LOVES';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'KEVO ON FIRE';
const packname = process.env.STICKER_PACKNAME || 'KEVO';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '254739165562';
...
const NotOwner = process.env.NOT_OWNER_MSG || 'This Command is For The Big Boss Only🫵';
